...
description: >
  ...
  by relevance to {{brand.domain}} content (food, GPS, health, running). Queue
...
# Facebook Group Scanner — {{brand.name}}

Scan joined Facebook groups for high-relevance posts to engage with as {{brand.persona}}.
...
+0.20 — post mentions brand reviewed on {{brand.domain}}: Fi, Tractive, Whistle, Ollie, Nom Nom,
