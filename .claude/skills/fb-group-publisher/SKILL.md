...
description: >
  Publish a {{brand.domain}} blog post to relevant Facebook groups. Use this skill
  ...
  Excel file. Always use this skill for any Facebook group posting task for {{brand.name_lower}}.
---
...
```
/{{brand.name_lower}}/facebook_groups_tracker.xlsx
```
...
**{{brand.persona}} voice reminders:**
- Lead with a relatable question or story
- Mention {{brand.mascot}} by name where natural
...
- **GPS/Gear posts:** Lead with safety/trail angle, mention {{brand.mascot}}'s real-world testing
- **Recipe posts:** Open with "{{brand.mascot}} went crazy for this" or similar
