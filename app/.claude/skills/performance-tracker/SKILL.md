...
- "Posts with {{brand.mascot}}-specific stories get 40% more comments — increase personal anecdotes"
...
Top: "{{brand.mascot}}'s GPS tracker saved us on a forest trail..." (120 eng)
...
3. Increase {{brand.mascot}} stories (40% more comments)
