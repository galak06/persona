 ...
 * regenerated. Mirrors `app/lib/brands_db/models.py::BRAND_COLUMNS`
 * (row shape) and `app/lib/brand_templates.py::BrandSpec` (create-request
...
/**
 * `POST /brands` body. Mirrors `BrandSpec` in `app/lib/brand_templates.py`
