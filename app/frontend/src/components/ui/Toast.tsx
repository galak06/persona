...
// eslint-disable-next-line react-refresh/only-export-components -- hook is intentionally co-located with its provider; splitting into a separate file would fragment a 3-export module for a dev-only HMR optimization
