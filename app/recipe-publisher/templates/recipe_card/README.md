...
```bash
BRAND_DIR=/path/to/app python recipe-publisher/templates/recipe_card/render.py
```
...
- **Photos** from the ready campaign folder
  `app/campaigns/recipes/ready/<seed-id>/`: `featured.jpg` (hero) and
