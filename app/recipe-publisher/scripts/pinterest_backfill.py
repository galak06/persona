...
def compose_description(title: str, excerpt_text: str, slide_index: int) -> str:
    ...
    tails = {
        1: "Full printable recipe on your-brand.com.",
        2: "Ingredients, portions, and prep notes at your-brand.com.",
        3: "Step-by-step instructions at your-brand.com.",
        4: "Save this for your next dog meal prep — recipe at your-brand.com.",
    }
    return f"{base}  {tails.get(slide_index, 'Full recipe at your-brand.com.')}"
