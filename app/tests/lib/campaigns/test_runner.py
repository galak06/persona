...
# `function == "main"` hooks are CLI entry points: they return a Unix exit
# code (0 = success, non-zero = failure), matching real hooks such as
# scripts/publish_prepared.py::main and scripts/distribute_fb_groups.py::main.
