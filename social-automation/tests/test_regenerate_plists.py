...
def test_plist_script_no_browser() -> None:
    ...
    _check(plist["Label"] == "com.dogfoodandfun.content-ideator")
...
def test_plist_skill_only() -> None:
    ...
    _check(plist["Label"] == "com.dogfoodandfun.site-analyzer")
...
def test_diff_create() -> None:
    action, _reason = diff_plist("com.dogfoodandfun.test", _sample_plist(), None)
...
def test_diff_no_change() -> None:
    ...
    action, _reason = diff_plist("com.dogfoodandfun.test", proposed, existing)
    _check(action == "OK")
...
def test_diff_update() -> None:
    ...
    action, reason = diff_plist("com.dogfoodandfun.test", proposed, existing)
