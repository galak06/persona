...
description: >
  ...
  Generates Nalla's Dad voice caption (150-200 words, no hashtags), fetches
...
## Overview
This skill automates the creation and publication of Facebook page posts from WordPress blog posts, generating engaging captions in "Nalla's Dad" voice and handling image management via the Facebook Graph API.
...
[Personal story — 2-3 sentences about experience with Nalla related to the topic]
