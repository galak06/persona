...
description: >
  Generate new blog post ideas for DogFoodAndFun.com and append them to the
...
## Purpose
Generate high-quality blog post ideas for DogFoodAndFun.com that match the engineer-led brand voice, leverage Nalla's personal context, and fill identified content gaps. Automatically append approved ideas to the Google Sheet to keep the content calendar current.
...
```json
{
  ...
  "Nalla_Context": "I ran the numbers in a spreadsheet. Fresh food costs us $4.20/day vs $1.80 for premium kibble, but the protein-per-dollar ratio tells a different story.",
...
2. **Nalla Context Required** — Each idea must include a specific personal angle from Nalla's experience
   - Examples: "I noticed Nalla's coat improved after..."
   - "We tried this approach and..."
   - "Nalla's behavior changed when..."
...
7. **Actionability** — Idea should be:
   ...
   - Within Nalla's experience or easily researched
...
3. **Personal First** — Ideas where Nalla has direct experience score highest. Prioritize those.
