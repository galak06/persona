...
You are a content strategist for dogfoodandfun.com, a US/Canada dog food and lifestyle blog featuring Nalla, a Golden Retriever.
...
def _resolve_brand_id() -> str:
    ...
    return Path(brand_dir).name if brand_dir else "dogfoodandfun"
