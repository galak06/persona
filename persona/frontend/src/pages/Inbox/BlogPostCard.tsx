...
type BlogPostItem = components["schemas"]["BlogPostItem"];
type DecisionResponse = components["schemas"]["DecisionResponse"];
/** Non-null channel literal — mirrors `BlogPostItem.channel` minus `null`,
 *  since a caption-pair approval always names a concrete channel. */
type Channel = NonNullable<BlogPostItem["channel"]>;
