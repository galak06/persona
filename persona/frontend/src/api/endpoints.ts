...
// No standalone "Channel" schema is generated (the query param is typed as
// a loose `string | null` by FastAPI/openapi-typescript); derive the real
// literal union from BlogPostItem's `channel` field instead, which openapi
// generates as a proper "both" | "fb_only" | "ig_only" enum.
type Channel = NonNullable<components["schemas"]["BlogPostItem"]["channel"]>;
