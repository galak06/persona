...
class TestIsSelfPingback:
    def test_pingback_from_own_domain_is_self(self):
        c = {
            "type": "pingback",
            "author_url": "https://your-brand.com/some-post/",
        }
        assert wp_scan.is_self_pingback(c, "https://your-brand.com") is True
    ...
    def test_pingback_from_external_domain_is_not_self(self):
        ...
        assert wp_scan.is_self_pingback(c, "https://your-brand.com") is False
    ...
    def test_regular_comment_never_classified_as_self_pingback(self):
        ...
        c = {
            "type": "comment",
            "author_url": "https://your-brand.com",
        }
        assert wp_scan.is_self_pingback(c, "https://your-brand.com") is False

    def test_http_https_and_www_variants_all_match(self):
        for base, url in [
            ("https://your-brand.com", "http://your-brand.com/x"),
            ("https://your-brand.com", "https://www.your-brand.com/x"),
            ("http://your-brand.com", "https://your-brand.com/x"),
        ]:
    ...
    def test_trackback_from_own_domain_also_trashed(self):
        c = {
            "type": "trackback",
            "author_url": "https://your-brand.com/foo",
        }
        assert wp_scan.is_self_pingback(c, "https://your-brand.com") is True
